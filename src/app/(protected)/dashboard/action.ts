    ...
    (async () => {
        const { textStream } = await streamText({
            ...
            prompt:`You are a AI code assistant who answers questions about the codebase. Your target audience is a technical intern who is looking to understand the codebase.
                    ...
                    AI assistant will not apologize that is not drawn directly from the context
                    AI assistant will not invent anything that is not drawn directly from the context.
                    Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, make sure there is no errors
                        `,
        });
